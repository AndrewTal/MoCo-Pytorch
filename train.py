...
parser.add_argument('--image_folder', metavar='DIR', required=True,
...
parser.add_argument('--dist-url', default='tcp://localhost:6987', type=str,
...
parser.add_argument(
    ...
    default=0.2,
    type=float,
    help='moco v1 softmax temperature (default: 0.07),moco v2 softmax temperature (default: 0.2)')

# options for moco v2
# To run MoCo v1 --mlp False --moco-t 0.07 --cos False`.
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # Data loading code
    traindir = os.path.join(args.image_folder)
    ...
    train_dataset = datasets.ImageFolder(
        traindir,
        moco.loader.TwoCropsTransform(T.Compose(augmentation)))
